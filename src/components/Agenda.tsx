...
const timeline = [
  { time: "17:30", title: "Регистрация и нетворкинг", desc: "Приветственный кофе, знакомства" },
  { time: "18:00", title: "Основные доклады", desc: "Арбитраж, рыночная инфраструктура, кросс-маркет стратегии" },
  { time: "19:00", title: "Панельная дискуссия", desc: "Представители бирж, брокеров и технологических компаний" },
  { time: "20:00", title: "Партнёрские сессии", desc: "Презентации спонсоров и демонстрации продуктов" },
  { time: "21:00", title: "Закрытый нетворкинг", desc: "Приватное общение для участников конференции" },
];
